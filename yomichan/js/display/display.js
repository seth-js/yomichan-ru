...
class Display extends EventDispatcher {
    ...
    async _findDictionaryEntries(isKanji, source, wildcardsEnabled, optionsContext) {
        if (isKanji) {
            ...
            const normalSearch = await yomichan.api.termsFind(source, findDetails, optionsContext);
            ...
            const lowerSearch = await yomichan.api.termsFind(source.toLowerCase(), findDetails, optionsContext);
